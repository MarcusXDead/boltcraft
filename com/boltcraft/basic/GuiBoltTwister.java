...
public class GuiBoltTwister extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
	private TileEntityBolttwister tileFurnace;

	public GuiBoltTwister(InventoryPlayer invPlayer, TileEntityBolttwister tile) {
		super(new ContainerBoltTwister(invPlayer, tile));
