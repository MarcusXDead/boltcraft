...
public class TileEntityBolttwister extends TileEntity implements ISidedInventory {
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			BoltTwister.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = BoltTwisterRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
			...
			if(item == Boltcraft.boltiron) return 1600;
